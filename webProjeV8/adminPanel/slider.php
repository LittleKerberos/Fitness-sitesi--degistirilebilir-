...
<?php endif ?>
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <button style="margin-left: 500px; margin-top: 50px; " type="button" class="btn btn-success aw-zoom" data-toggle="modal" data-target="#sliderekle">
					  ...
					  <i class="fa-solid fa-sliders"></i><br>Slider Ekle
				...
				$sorgu = $conn->query("SELECT * FROM slider order by slider_sira ");
				...
				while ($cikti = $sorgu->fetch(PDO::FETCH_ASSOC)) { ?>
                          ...
                          <tr>
                            <td>	<img src="../image/<?php echo $cikti['slider_resim']; 	 ?>">		</td>
                        ...
                        <?php endif ?>
                         ...
                         <td><a style="text-decoration: none; color: white;" href="sliderguncelle.php?id=<?php echo $cikti['slider_id'] ?>">  <button   type="button" class="btn btn-primary aw-zoom" >Güncelle</button></a></td>
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="sliderEkleİslem.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                        <label for="exampleInputUsername1">Slider Resim</label>
                        <input type="file" class="form-control" id="exampleInputUsername1" placeholder="" name="resim" value="" required>
                      </div>
